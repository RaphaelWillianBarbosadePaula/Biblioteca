function saveUser() {
    ...
    if (userId) {
      ...
      fetch("../models/usuarios/editarAutores.php", {
        method: "POST",
      ...
      fetch("../models/autores/cadastrarAutores.php", {
        method: "POST",
        body: JSON.stringify(data),
        headers: { "Content-type": "application/json; charset=UTF-8" },
      })
  ...
  function consultar(userId) {
    fetch(`../models/autores/consultarAutores.php?userId=${userId}`)
      .then(function (response) {
        response.json().then(function (data) {
          var modalElement = document.getElementById("modalAutores");
          var modalAutores = bootstrap.Modal.getInstance(modalElement);
  ...
  function excluir(userId) {
    var modalElementDelete = document.getElementById("modalExcluirAutores");
    var modalExcluirAutores = bootstrap.Modal.getInstance(modalElementDelete);
    modalExcluirAutores.show();
  ...
  function realDeleteUser() {
    ...
    fetch(`../models/autores/excluirAutores.php?userId=${deleteUserId}`, {
      method: "DELETE",
    })
      .then(function (response) {
        $("#modalExcluirAutores").modal("hide");
